...
<div class="pu-header__wcag__font">
    <span class="pu-header__wcag__font__title"><%=AuthenticationEndpointUtil.i18n(resourceBundle,"font.size")%></span>
    <div class="pu-header__wcag__font__action">
      <button
        ...
        aria-label="<%=AuthenticationEndpointUtil.i18n(resourceBundle,"font.size.small")%>"
      ...
      ><button
        ...
        aria-label="<%=AuthenticationEndpointUtil.i18n(resourceBundle,"font.size.big")%>"
