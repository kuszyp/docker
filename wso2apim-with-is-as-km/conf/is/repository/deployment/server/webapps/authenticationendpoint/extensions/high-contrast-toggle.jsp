...
>
  <%= AuthenticationEndpointUtil.i18n(resourceBundle, "high.contrast") %>
...
<script>
  ...
  function applyHighContrastToButton() {
      ...
      highContrastButton.setAttribute("aria-label",  "<%= AuthenticationEndpointUtil.i18n(resourceBundle, "high.contrast.turn.off") %>");
  }
  ...
  function removeHighContrastFromButton() {
      ...
      highContrastButton.setAttribute("aria-label", "<%= AuthenticationEndpointUtil.i18n(resourceBundle, "high.contrast.turn.on") %>");
  }
