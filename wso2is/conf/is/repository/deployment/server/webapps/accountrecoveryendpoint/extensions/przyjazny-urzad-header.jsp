...
<jsp:directive.include file="przyjazny-urzad-localize.jsp" />
<%@ page import="org.wso2.carbon.identity.mgt.endpoint.util.IdentityManagementEndpointUtil" %>
<%@ page import="java.io.File" %>

<jsp:directive.include file="przyjazny-urzad-layout-resolver.jsp"/>
...
<title><%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "page.title")%></title>
