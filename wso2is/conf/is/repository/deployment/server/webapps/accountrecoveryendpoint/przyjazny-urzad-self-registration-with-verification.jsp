...
<jsp:directive.include file="extensions/przyjazny-urzad-localize.jsp"/>
<jsp:directive.include file="tenant-resolve.jsp"/>
<jsp:directive.include file="extensions/przyjazny-urzad-layout-resolver.jsp"/>
...
<%-- <jsp:include page="extensions/przyjazny-urzad-language-change.jsp"/>--%>
<layout:main layoutName="<%= layout %>" layoutFileRelativePath="<%= layoutFileRelativePath %>" data="<%= layoutData %>">
    <layout:component componentName="ProductHeader">
        <%-- product-title --%>
        <%
            File productTitleFile = new File(getServletContext().getRealPath("extensions/przyjazny-urzad-product-title.jsp"));
            if (productTitleFile.exists()) {
        %>
        <jsp:include page="extensions/przyjazny-urzad-product-title.jsp"/>
        <% } else { %>
    ...
    <layout:component componentName="MainSection">
        ...
        <div class="pu-login">
            ...
            <div class="pu-login__main">
                <h2 class="pu-login__title"><%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "your.account")%></h2>

                <p>
                    <%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "your.account.description")%>
                </p>
                <%-- content --%>
                <% if (skipSignUpEnableCheck) { %>
                    ...
                    <form action="processregistration.do" method="post" id="register">
                        ...
                        <div>
                            ...
                            <div class="<% if (claim.getRequired()) {%> required <%}%>field">
                                <label for="country-dropdown" <% if (claim.getRequired()) {%>
                                       class="control-label" <%}%>>
                        ...
                        <% } else { %>
                        <table class="pu-login__information">
<%--                            <tr>--%>
<%--                                <th>--%>
<%--                                    <div>--%>
<%--                                        <%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "your.account.name")%>--%>
<%--                                    </div>--%>
<%--                                </th>--%>
<%--                                <td>--%>
<%--                                    <div>--%>
<%--                                        <span><%=Encode.forHtmlAttribute(username)%></span>--%>
<%--                                    </div>--%>
<%--                                </td>--%>
<%--                            </tr>--%>
                            ...
                            <%
                                for (Claim claim : claims) {
                                    ...
                                    if (claimUri.equals("http://wso2.org/claims/dob")) {
                                        claimCode = "claim.dob";
                                    } else if (claimUri.equals("http://wso2.org/claims/lastname")) {
                                        claimCode = "claim.lastname";
                                    } else if (claimUri.equals("http://wso2.org/claims/givenname")) {
                                        claimCode = "claim.givenname";
                                    } else if (claimUri.equals("http://wso2.org/claims/pid")) {
                                        claimCode = "claim.pid";
                                    }

                                    boolean shouldRenderRow = !(claimUri.equals("http://wso2.org/claims/pckip") || claimUri.equals("http://wso2.org/claims/pcatk") || claimUri.equals("http://wso2.org/claims/pcid") || claimUri.equals("http://wso2.org/claims/pcivl") || claimUri.equals("http://wso2.org/claims/pcstk") || claimUri.equals("http://wso2.org/claims/pctl"));

                                    if (StringUtils.isNotEmpty(claimValue) && shouldRenderRow) { %>
                            <tr>
                                <th>
                                    <div>
                                        <% if (!claimCode.isEmpty()) {
                                        %>
                                        <%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, claimCode)%><%
                                    } else {
                                    %><%=IdentityManagementEndpointUtil.i18nBase64(recoveryResourceBundle, claim.getDisplayName())%><%
                                        } %>
                                    </div>
                                ...
                                <td>
                                    <div>
                                        <span><%= Encode.forHtmlAttribute(claimValue)%></span>
                                    </div>
                                </td>
                            </tr>
                            <% }
                        ...
                        <div class="field">
                            ...
                            %>
                            <h2 class="pu-login__title"><%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "agreements.title")%></h2>
                            <p>
                                    <%--Cookie Policy--%>
                                        <%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,
                            ...
                            <div class="ui divider hidden"></div>
                            <div class="pu-login__checkbox__container">
                                    <%--Terms/Privacy Policy--%>
                                    <div class="pu-login__checkbox required">
                                        <input id="termsCheckbox1" class="pu-login__checkbox__input" type="checkbox"/>
                                        <label for="termsCheckbox1"><%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,
                                                "agreements.regulations")%>
                                            <a href="https://test-cdn.pm.bydgoszcz.pl/resources/files/consents/tenants/mnp_bydgoszcz/pl/REGULAMINY.REGULAMIN.DOKUMENT.pdf"
                                               target="policy-pane">
                                                <%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "agreements.regulations.link")%>
                                            </a>.</label>
                                    </div>

                                    <div class="pu-login__checkbox required">
                                        <input id="termsCheckbox2" class="pu-login__checkbox__input" type="checkbox"/>
                                        <label for="termsCheckbox2"><%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,
                                                "agreements.cookies.acceptance")%>
                                            <a href="https://test-cdn.pm.bydgoszcz.pl/resources/files/consents/tenants/mnp_bydgoszcz/pl/REGULAMINY.POLITYKA_COOKIES.DOKUMENT.pdf"
                                               target="policy-pane">
                                                <%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "agreements.cookies.acceptance.link")%>
                                            </a>.</label>
                                    </div>

                                    <div class="pu-login__checkbox required">
                                        <input id="termsCheckbox3" class="pu-login__checkbox__input" type="checkbox"/>
                                        <label for="termsCheckbox3"><%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,
                                                "agreements.rodo.o4b")%>
                                            <a href="https://test-cdn.pm.bydgoszcz.pl/resources/files/consents/tenants/mnp_bydgoszcz/pl/REGULAMINY.TRESC_KLAUZULA_O4B.DOKUMENT.pdf" target="policy-pane">
                                                <%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "agreements.rodo.o4b.link")%>
                                            </a>.</label>
                                    </div>

                                    <div class="pu-login__checkbox required">
                                        <input id="termsCheckbox4" class="pu-login__checkbox__input" type="checkbox"/>
                                        <label for="termsCheckbox4"><%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,
                                                "agreements.rodo.city")%>
                                            <a href="https://test-cdn.pm.bydgoszcz.pl/resources/files/consents/tenants/mnp_bydgoszcz/pl/REGULAMINY.TRESC_KLAUZULA_URZAD.DOKUMENT.pdf" target="policy-pane">
                                                <%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "agreements.rodo.city.link")%>
                                            </a>.</label>
                                    </div>
                                    <%--End Terms/Privacy Policy--%>
                            </div>
                            <div class="pu-login__error">
                                <% if (error) { %>
                                <p class="ui negative message" id="server-error-msg">
                                    <%=IdentityManagementEndpointUtil.i18nBase64(recoveryResourceBundle, errorMsg)%>
                                </p>
                                <% } %>

                                <p class="ui negative message" id="error-msg" hidden="hidden">
                                </p>
                            </div>
                            <div class="ui divider hidden"></div>
                            <div class="field">
            ...
            <div class="pu-login__action">
                <a href="javascript:goBack()" class="pu-btn pu-btn--secondary">
                ...
                <button id="registrationSubmit"
                        ...
                        form="register"
                        type="submit">
                    <%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "actions.next")%>
                </button>
            </div>
...
<%-- footer --%>
<%
    File footerFile = new File(getServletContext().getRealPath("extensions/przyjazny-urzad-footer.jsp"));
    if (footerFile.exists()) {
%>
<jsp:include page="extensions/przyjazny-urzad-footer.jsp"/>
<% } else { %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#register").submit(function (e) {
            ...
            if (!$("#termsCheckbox1")[0].checked) {
                error_msg.text("<%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,
                            "agreements.regulations.error")%>");
                error_msg.show();
                $("html, body").animate({scrollTop: error_msg.offset().top}, 'slow');
                return false;
            }

            if (!$("#termsCheckbox2")[0].checked) {
                error_msg.text("<%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,
                            "aggrements.cookies.acceptance.error")%>");
                error_msg.show();
                $("html, body").animate({scrollTop: error_msg.offset().top}, 'slow');
                return false;
            }

            if (!$("#termsCheckbox3")[0].checked) {
                error_msg.text("<%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,
                            "agreements.rodo.o4b.error")%>");
                error_msg.show();
                $("html, body").animate({scrollTop: error_msg.offset().top}, 'slow');
                return false;
            }

            if (!$("#termsCheckbox4")[0].checked) {
                error_msg.text("<%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle,
                            "agreements.rodo.city.error")%>");
                error_msg.show();
                $("html, body").animate({scrollTop: error_msg.offset().top}, 'slow');
                return false;
            }
