...
>
  <button
    ...
    aria-label="<%= AuthenticationEndpointUtil.i18n(resourceBundle, "language.open") %>"
    onclick="toggleDropdown()"
    type="button"
  >
    <%= AuthenticationEndpointUtil.i18n(resourceBundle, "language.title") %>
    ...
    <span class="pu-header__wcag__element__activeLanguage">pls</span>
  </button>
  <ul
    role="listbox"
    id="pu-dropdown"
  ...
  >
    ...
    >
      <%= AuthenticationEndpointUtil.i18n(resourceBundle, "language.polish") %>
    ...
    >
      <%= AuthenticationEndpointUtil.i18n(resourceBundle, "language.english") %>
      <span class="pu-dropdown__option__check" style="display: none">
        <img alt="" width="24" height="24" src="images/icon-check.svg" />
      </span>
    </li>
