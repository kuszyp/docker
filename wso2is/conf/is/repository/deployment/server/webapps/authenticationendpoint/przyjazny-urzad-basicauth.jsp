...
<form class="pu-form" action="<%=loginFormActionURL%>" method="post" id="loginForm">
    <%
   ...
   <% } %>
    ...
    <% } %>
    <div class="pu-form__container">
            <img class="pu-form__icon" src="./images/icon-password.svg" alt="" aria-hidden="true">
                <input
                    class="pu-form__input"
                    type="password"
                    id="password"
    ...
    <% if (isPasswordRecoveryEnabledInTenant) { %>
        <div class="pu-form__container pu-form__container--remind-password">
            <a
...
<%--    </div>--%>
    ...
    <div class="pu-form__actions">
            <button
                class="pu-btn pu-btn--primary"
                type="submit"
            >
                <%=StringEscapeUtils.escapeHtml4(AuthenticationEndpointUtil.i18n(resourceBundle, "login"))%>
            </button>
